...
import project.pipepipe.extractor.services.niconico.dataparser.NicoNicoStreamInfoDataParser.parseFromSearchContentJson
...
class NicoNicoSearchExtractor(url: String): SearchExtractor(url) {
    ...
    override suspend fun fetchGivenPage(
        ...
        if (currentState == null) {
            ...
            data.forEach {
                commit { parseFromSearchContentJson(it) }
            }
